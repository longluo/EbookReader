...
extern "C"
JNIEXPORT jobjectArray JNICALL Java_com_longluo_ebookreader_formats_PluginCollection_nativePlugins(JNIEnv* env, jobject thiz, jobject systemInfo) {
...
extern "C"
JNIEXPORT void JNICALL Java_com_longluo_ebookreader_formats_PluginCollection_free(JNIEnv* env, jobject thiz) {
