...
#include "ebookreader/src/bookmodel/BookModel.h"
#include "ebookreader/src/formats/FormatPlugin.h"
#include "ebookreader/src/library/Author.h"
#include "ebookreader/src/library/Book.h"
#include "ebookreader/src/library/Tag.h"
#include "ebookreader/src/library/UID.h"
...
extern "C"
JNIEXPORT jint JNICALL Java_com_longluo_ebookreader_formats_NativeFormatPlugin_readMetainfoNative(JNIEnv* env, jobject thiz, jobject javaBook) {
...
extern "C"
JNIEXPORT jobject JNICALL Java_com_longluo_ebookreader_formats_NativeFormatPlugin_readEncryptionInfosNative(JNIEnv* env, jobject thiz, jobject javaBook) {
	shared_ptr<FormatPlugin> plugin = findCppPlugin(thiz);
	if (plugin.isNull()) {
		return 0;
	}
...
extern "C"
JNIEXPORT void JNICALL Java_com_longluo_ebookreader_formats_NativeFormatPlugin_readUidsNative(JNIEnv* env, jobject thiz, jobject javaBook) {
	shared_ptr<FormatPlugin> plugin = findCppPlugin(thiz);
	if (plugin.isNull()) {
		return;
	}
...
extern "C"
JNIEXPORT void JNICALL Java_com_longluo_ebookreader_formats_NativeFormatPlugin_detectLanguageAndEncodingNative(JNIEnv* env, jobject thiz, jobject javaBook) {
	shared_ptr<FormatPlugin> plugin = findCppPlugin(thiz);
	if (plugin.isNull()) {
		return;
	}
...
extern "C"
JNIEXPORT jint JNICALL Java_com_longluo_ebookreader_formats_NativeFormatPlugin_readModelNative(JNIEnv* env, jobject thiz, jobject javaModel, jstring javaCacheDir) {
	shared_ptr<FormatPlugin> plugin = findCppPlugin(thiz);
	if (plugin.isNull()) {
		return 1;
	}
...
extern "C"
JNIEXPORT jstring JNICALL Java_com_longluo_ebookreader_formats_NativeFormatPlugin_readAnnotationNative(JNIEnv* env, jobject thiz, jobject file) {
	shared_ptr<FormatPlugin> plugin = findCppPlugin(thiz);
	if (plugin.isNull()) {
		return 0;
	}
...
extern "C"
JNIEXPORT void JNICALL Java_com_longluo_ebookreader_formats_NativeFormatPlugin_readCoverNative(JNIEnv* env, jobject thiz, jobject file, jobjectArray box) {
	shared_ptr<FormatPlugin> plugin = findCppPlugin(thiz);
	if (plugin.isNull()) {
		return;
	}
