...
public class LogUtils {
    private static String LOG_TAG = "EBookReader"; // 默认的tag
    ...
    public static void init(Context context) { // 在Application中初始化
        LOG_FILE_PATH = Environment.getExternalStorageDirectory().getPath() + File.separator + ERApplication.getContext().getPackageName();
        LOG_FILE_NAME = "Log";
    }
