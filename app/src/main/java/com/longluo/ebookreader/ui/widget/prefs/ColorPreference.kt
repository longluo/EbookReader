...
class ColorPreference(context: Context, attrs: AttributeSet) : Preference(context, attrs),
    ...
    init {
        isPersistent = true
        layoutResource = com.longluo.ebookreader.R.layout.view_preference
    ...
    override fun onBindViewHolder(holder: PreferenceViewHolder) {
        val v = com.longluo.ebookreader.ui.widget.prefs.Preference.bindView<ColorPanelView>(
            context, holder, icon, title, summary, widgetLayoutResource,
            com.longluo.ebookreader.R.id.cpv_preference_preview_color_panel, 30, 30
        )
