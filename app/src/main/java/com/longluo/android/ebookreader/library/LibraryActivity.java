...
import com.longluo.android.ebookreader.FBUtil;
...
import com.longluo.ebookreader.book.BookEvent;
...
import com.longluo.ebookreader.library.BookTree;
import com.longluo.ebookreader.library.ExternalViewTree;
import com.longluo.ebookreader.library.FileTree;
import com.longluo.ebookreader.library.LibraryTree;
import com.longluo.ebookreader.library.RootTree;
import com.longluo.ebookreader.library.SearchResultsTree;
import com.longluo.ebookreader.library.SyncLabelTree;
...
public class LibraryActivity extends TreeActivity<LibraryTree> implements MenuItem.OnMenuItemClickListener, View.OnCreateContextMenuListener, IBookCollection.Listener<Book> {
    static final String START_SEARCH_ACTION = "action.ebookreader.library.start-search";
