...
JavaClass AndroidUtil::Class_ZLibrary("com/longluo/zlibrary/core/library/ZLibrary");
JavaClass AndroidUtil::Class_ZLFile("com/longluo/zlibrary/core/filesystem/ZLFile");
JavaClass AndroidUtil::Class_FileInfo("com/longluo/zlibrary/core/fonts/FileInfo");
JavaClass AndroidUtil::Class_FileEncryptionInfo("com/longluo/zlibrary/core/drm/FileEncryptionInfo");
JavaClass AndroidUtil::Class_ZLFileImage("com/longluo/zlibrary/core/image/ZLFileImage");
JavaClass AndroidUtil::Class_ZLTextModel("com/longluo/zlibrary/text/model/ZLTextModel");

JavaClass AndroidUtil::Class_Encoding("com/longluo/zlibrary/core/encodings/Encoding");
JavaClass AndroidUtil::Class_EncodingConverter("com/longluo/zlibrary/core/encodings/EncodingConverter");
JavaClass AndroidUtil::Class_JavaEncodingCollection("com/longluo/zlibrary/core/encodings/JavaEncodingCollection");

JavaClass AndroidUtil::Class_NativeFormatPlugin("com/longluo/fbreader/formats/NativeFormatPlugin");
JavaClass AndroidUtil::Class_PluginCollection("com/longluo/fbreader/formats/PluginCollection");
JavaClass AndroidUtil::Class_Paths("com/longluo/fbreader/Paths");
JavaClass AndroidUtil::Class_AbstractBook("com/longluo/fbreader/book/AbstractBook");
JavaClass AndroidUtil::Class_Book("com/longluo/fbreader/book/Book");
JavaClass AndroidUtil::Class_Tag("com/longluo/fbreader/book/Tag");
JavaClass AndroidUtil::Class_BookModel("com/longluo/fbreader/bookmodel/BookModel");
...
bool AndroidUtil::init(JavaVM* jvm) {
	...
	StaticMethod_NativeFormatPlugin_create = new StaticObjectMethod(Class_NativeFormatPlugin, "create", Class_NativeFormatPlugin, "(Lcom/longluo/zlibrary/core/util/SystemInfo;Ljava/lang/String;)");
	...
	Constructor_FileInfo = new Constructor(Class_FileInfo, "(Ljava/lang/String;Lcom/longluo/zlibrary/core/drm/FileEncryptionInfo;)V");
	...
	Constructor_ZLFileImage = new Constructor(Class_ZLFileImage, "(Lcom/longluo/zlibrary/core/filesystem/ZLFile;Ljava/lang/String;[I[ILcom/longluo/zlibrary/core/drm/FileEncryptionInfo;)V");
	...
	Method_Book_addTag = new VoidMethod(Class_AbstractBook, "addTag", "(Lcom/longluo/fbreader/book/Tag;)");
	Method_Book_addUid = new VoidMethod(Class_AbstractBook, "addUid", "(Ljava/lang/String;Ljava/lang/String;)");

	StaticMethod_Tag_getTag = new StaticObjectMethod(Class_Tag, "getTag", Class_Tag, "(Lcom/longluo/fbreader/book/Tag;Ljava/lang/String;)");
	...
	Method_BookModel_setBookTextModel = new VoidMethod(Class_BookModel, "setBookTextModel", "(Lcom/longluo/zlibrary/text/model/ZLTextModel;)");
	Method_BookModel_setFootnoteModel = new VoidMethod(Class_BookModel, "setFootnoteModel", "(Lcom/longluo/zlibrary/text/model/ZLTextModel;)");
	Method_BookModel_addImage = new VoidMethod(Class_BookModel, "addImage", "(Ljava/lang/String;Lcom/longluo/zlibrary/core/image/ZLImage;)");
	Method_BookModel_registerFontFamilyList = new VoidMethod(Class_BookModel, "registerFontFamilyList", "([Ljava/lang/String;)");
	Method_BookModel_registerFontEntry = new VoidMethod(Class_BookModel, "registerFontEntry", "(Ljava/lang/String;Lcom/longluo/zlibrary/core/fonts/FileInfo;Lcom/longluo/zlibrary/core/fonts/FileInfo;Lcom/longluo/zlibrary/core/fonts/FileInfo;Lcom/longluo/zlibrary/core/fonts/FileInfo;)");
